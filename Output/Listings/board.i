...
static uint32_t _SysTick_Config(rt_uint32_t ticks)
{
    ...
    (*(rt_uint32_t *)((0xE000E010UL) + 0x4)) = ticks - 1; 
    (*(rt_uint8_t *)(0xE000ED23UL)) = 0xFF;
    (*(rt_uint32_t *)((0xE000E010UL) + 0x8))  = 0;
    (*(rt_uint32_t *)((0xE000E010UL) + 0x0)) = 0x07;  
...
static uint32_t rt_heap[1024];	
__weak void *rt_heap_begin_get(void)
{
    return rt_heap;
}

__weak void *rt_heap_end_get(void)
{
    return rt_heap + 1024;
}
...
{	
	...
	__NVIC_SetPriorityGrouping(((uint32_t)0x500));		
...
__attribute__((used)) const init_fn_t __rt_init_uart_init __attribute__((section(".rti_fn." "1"))) = uart_init;

__attribute__((used)) const init_fn_t __rt_init_rgbInit __attribute__((section(".rti_fn." "1"))) = rgbInit;
...
void rt_hw_console_output(const char *str)
{
	...
	while ( *str != '\0' )
    {
        ...
        if ( *str == '\n' )
        {
            USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), '\r' );
            while ( USART_GetFlagStatus( ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0080) ) == RESET );
        }
 
        USART_SendData( ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), *str++ );
        while ( USART_GetFlagStatus( ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0080) ) == RESET );
	}
