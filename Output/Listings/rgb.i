...
void rgbInit(void)
{
	...
	RgbGpioInitStructure.GPIO_Pin   = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0020);
	RgbGpioInitStructure.GPIO_Speed = GPIO_Speed_10MHz;
	RgbGpioInitStructure.GPIO_Mode  = GPIO_Mode_Out_PP;
	
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)), &RgbGpioInitStructure);
	rgbRedOff();
	rgbGreenOff();
	rgbBlueOff();
	return ;
...
void rgbGreenOn(void)
{
 	GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)) , ((uint16_t)0x0002));
