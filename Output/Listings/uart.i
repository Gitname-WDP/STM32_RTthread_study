...
UsartDataConfig Usart1Connfig = {0, 0, 1024};
UsartDataConfig Usart2Connfig = {0, 0, 1024};
UsartDataConfig Usart3Connfig = {0, 0, 1024};

uint8_t usart_recv_data_flag = 0;	
USART_TypeDef* usart_num[5] = {((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4C00)), ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x5000)),};
...
void usart1SendData(uint8_t data)
{
    uint16_t nextWriteIndex = (txWriteIndex + 1) % 1024;
...
void USART1_IRQHandler(void)
{
    ...
    {
        uint8_t data = USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
        uint16_t nextWriteIndex = (rxWriteIndex + 1) % 1024;
    ...
    if (USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0727)) != RESET)
    {
        if (txReadIndex != txWriteIndex)
        {
            USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), txBuffer[txReadIndex]);
            txReadIndex = (txReadIndex + 1) % 1024;
        }
        else
        {
...
void USART2_IRQHandler(void)
{
    ...
    {
        uint8_t data = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));
        uint16_t nextWriteIndex = (rxWriteIndex + 1) % 1024;
    ...
    if (USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), ((uint16_t)0x0727)) != RESET)
    {
        if (txReadIndex != txWriteIndex)
        {
            USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), txBuffer[txReadIndex]);
            txReadIndex = (txReadIndex + 1) % 1024;
        }
        else
        {
...
void USART3_IRQHandler(void)
{
	   ...
	   {
		   uint8_t data = USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)));
		   uint16_t nextWriteIndex = (rxWriteIndex + 1) % 1024;
	   ...
	   if (USART_GetITStatus(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), ((uint16_t)0x0727)) != RESET)
	   {
		   if (txReadIndex != txWriteIndex)
		   {
			   USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4800)), txBuffer[txReadIndex]);
			   txReadIndex = (txReadIndex + 1) % 1024;
		   }
		   else
		   {
